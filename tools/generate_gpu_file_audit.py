...
ROLE_MAP = {
    ...
    "convec-1dfft-cpu.f90": ("Convection reference", "CPU/reference 1D FFT convection variant", "Reference"),
    "convec-1dfft-gpu.f90": ("Convection reference", "GPU/reference 1D FFT convection variant", "Reference"),
    "convec-2dfft-cpu.f90": ("Convection reference", "CPU/reference 2D FFT convection variant", "Reference"),
    "convec-2dfft-gpu.f90": ("Convection reference", "GPU/reference 2D FFT convection variant", "Reference"),
    "press_stag_array.f90": ("Pressure", "GPU pressure RHS, halos, cuFFT orchestration", "Runtime hot path"),
    "press_stag_array-cpu.f90": ("Pressure reference", "CPU/reference pressure implementation", "Reference"),
    "press_stag_array-gpu.f90": ("Pressure reference", "Earlier GPU pressure reference", "Reference"),
